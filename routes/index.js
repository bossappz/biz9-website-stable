...
router.get('/sql',function(req, res) {
    ...
    async.series([
        ...
        function(call){
            ...
            biz9.update_item(db,G_DT_BLANK,helper.item,function(error,result) {
                helper.item=result;
        ...
        function(call){
            sql = {};
            sort={};
            biz9.get_sql(db,G_DT_BLANK,sql,sort,function(error,result_list) {
        ...
        function(call){
            ...
            page_size=12;
            biz9.get_sql_paging(db,G_DT_PRODUCT,sql,sort,page_current,page_size,function(error,result_list,total_item_count,page_page_count){
        ...
        function(call){
            biz9.get_item(db,G_DT_BLANK,helper.item.tbl_id,function(error,result) {
